...
//
const BotName = '🍑 RIZKI BOT 🍑'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/'; // Nama Instagramlu cok
const whatsapplu = '08xx'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Rizki`))
...
axios.get(`https://st4rz.herokuapp.com/api/nulis?text=${teks}&apiKey=zFuV88pxcIiCWuYlwg57`).then((res) => {
...
/*   if (text.includes("#yt"))
   ...
   {
    var items = ["ullzang girl", "cewe cantik", "hijab cantik", "russia girl"];
